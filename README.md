Creating embedded C++ program on De1_SoC board to use hardware peripherals such as VGA, Microphone, speaker, keyboard, mouse, 7 seg display, and interrupt signals
